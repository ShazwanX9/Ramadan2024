...
class RockPaperScissorsSpockLizardApp(App):
    ROCK = "rock"
    PAPER = "paper"
    SCISSORS = "scissors"
    SPOCK = "spock"
    ...
    def loading(self) -> None:
        self.p1_text = RockPaperScissorsSpockLizardApp.LOADING
        self.p2_text = RockPaperScissorsSpockLizardApp.LOADING
        self.player_turn_text = RockPaperScissorsSpockLizardApp.LOADING
        self.setup()
    ...
    def setup(self) -> None:
        ...
        p1extension = [".png", ".jpg"][self.p1_text in (RockPaperScissorsSpockLizardApp.SPOCK, RockPaperScissorsSpockLizardApp.LIZARD)]
        p2extension = [".png", ".jpg"][self.p2_text in (RockPaperScissorsSpockLizardApp.SPOCK, RockPaperScissorsSpockLizardApp.LIZARD)]
        ...
        self.is_player_1 = (self.player_turn_text==RockPaperScissorsSpockLizardApp.LEFT)
    ...
    def calculate_score(self, option) -> None:
        ...
        if win: win = (-1, 1)[(self.p1_text, self.p2_text) in RockPaperScissorsSpockLizardApp.combination]

        # Invert the player if player 2
        if (not self.is_player_1) and win: win = -win

        points = (
            option == RockPaperScissorsSpockLizardApp.WIN and win == 1, 
            option == RockPaperScissorsSpockLizardApp.DRAW and win == 0, 
            option == RockPaperScissorsSpockLizardApp.LOSE and win == -1, 
        )
    ...
    def build(self) -> None:
        ...
        return Builder.load_file("rockpaperscissors.kv")

if __name__ == '__main__':
    RockPaperScissorsSpockLizardApp().run()